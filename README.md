...
<div style="display: flex; flex-wrap: wrap; justify-content: center">
    <span style="border: 1px solid orange; color: white; font-weight: bold;">JAVASCRIPT</span>
    <span style="border: 1px solid orange; color: white; font-weight: bold;">REACT</span>
</div>
